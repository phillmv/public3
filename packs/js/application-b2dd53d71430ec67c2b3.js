...
/***/ "./app/javascript/entry_folding.js":
/*!*****************************************!*\
  !*** ./app/javascript/entry_folding.js ***!
  \*****************************************/
/*! no static exports found */
...
/***/ "./app/javascript/file_uploading.js":
/*!******************************************!*\
  !*** ./app/javascript/file_uploading.js ***!
  \******************************************/
...
var uploadFile = function uploadFile(file, file_input) {
  // your form needs the file_field direct_upload: true, which
  // provides data-direct-upload-url
  var url = file_input.dataset.directUploadUrl;
  var upload = new _rails_activestorage__WEBPACK_IMPORTED_MODULE_0__["DirectUpload"](file, url);
  upload.create(function (error, blob) {
    if (error) {
      ...
      var attachment_link; // only set the img tag if it looks like an image!
      ...
      textarea.setRangeText(attachment_link, textarea.selectionStart, textarea.selectionEnd, "end"); // Add an appropriately-named hidden input to the form with a
...
document.addEventListener("turbolinks:load", function () {
  var file_input, textarea; // TODO: surely a SelectorAll and a for loop better eh?

  file_input = document.querySelector('input[type=file]#entry_files');
  textarea = document.querySelector('textarea#entry_body'); // handling uploads
  // Bind to normal file selection

  if (file_input) {
    bind_input_change(file_input); // bind to textarea paste events; we make it conditional on the
...
function bind_textarea_paste(textarea, file_input) {
  textarea.addEventListener('paste', function (e) {
    var clipboard_files = e.clipboardData.files; // if there are no files, then we want to do the default
...
/***/ "./app/javascript/on_load_behaviours.js":
/*!**********************************************!*\
  !*** ./app/javascript/on_load_behaviours.js ***!
  \**********************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var entry_folding__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! entry_folding */ "./app/javascript/entry_folding.js");
/* harmony import */ var entry_folding__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(entry_folding__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var file_uploading__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! file_uploading */ "./app/javascript/file_uploading.js");
/* harmony import */ var text_expanding__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! text_expanding */ "./app/javascript/text_expanding.js");
/* harmony import */ var textarea_sizing__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! textarea_sizing */ "./app/javascript/textarea_sizing.js");
/* harmony import */ var task_list_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! task_list_handler */ "./app/javascript/task_list_handler.js");
  ...
  if (current_nwo) {
    ...
    if (e.ctrlKey && e.which == 78) {
      if (safe_to_navigate_away_from_entry()) {
        window.location.pathname = "/".concat(nwo, "/new");
      }
    }
    ...
    if (e.ctrlKey && e.code == "BracketLeft") {
      switch (window.current_action.name) {
        case "calendar/daily":
          if (safe_to_navigate_away_from_entry()) {
            window.location.pathname = "/".concat(nwo);
          }

          break;

        case "calendar/weekly":
          window.location.pathname = "/".concat(nwo, "/calendar/daily");
          break;

        case "calendar/monthly":
          window.location.pathname = "/".concat(nwo, "/calendar/weekly");
          break;
    ...
    if (e.ctrlKey && e.code == "BracketRight") {
      switch (window.current_action.name) {
        ...
        case "calendar/weekly":
          window.location.pathname = "/".concat(nwo, "/calendar");
          break;
      }
    }
  }
...
document.addEventListener("turbolinks:load", function () {
  setFilterHandler();
  savedSearch(); // pretty sure this is about ensuring the main entry is in view
...
function savedSearch() {
  ...
  if (saved_search) {
    saved_search.addEventListener("submit", function (e) {
...
function setFilterHandler() {
  ...
  try {
    for (var _iterator = filter_dropdown_links[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var dropdown_link = _step.value;
      dropdown_link.addEventListener("click", function (e) {
        ...
        if (document.searchform.search_query.value.indexOf(selected_filter) == -1) {
          document.searchform.search_query.value = "".concat(document.searchform.search_query.value, " ").concat(selected_filter);
        }
...
__webpack_require__(/*! on_load_behaviours */ "./app/javascript/on_load_behaviours.js"); // Uncomment to copy all static images under ../images to the output folder and reference
...
/***/ "./app/javascript/task_list.coffee":
/*!*****************************************!*\
  !*** ./app/javascript/task_list.coffee ***!
  \*****************************************/
/*! no static exports found */
...
/***/ "./app/javascript/task_list_handler.js":
/*!*********************************************!*\
  !*** ./app/javascript/task_list_handler.js ***!
  \*********************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var task_list__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! task_list */ "./app/javascript/task_list.coffee");
/* harmony import */ var task_list__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(task_list__WEBPACK_IMPORTED_MODULE_0__);
...
document.addEventListener("turbolinks:load", function () {
  ...
  try {
    for (var _iterator = markdown_divs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var mdiv = _step.value;
      new task_list__WEBPACK_IMPORTED_MODULE_0___default.a(mdiv);
    }
  } catch (err) {
    _didIteratorError = true;
    _iteratorError = err;
...
document.addEventListener("tasklist:changed", function (e) {
  ...
  var form = e.target.closest("form"); // task-list-field holds the raw markdown content
...
/***/ "./app/javascript/text_expanding.js":
/*!******************************************!*\
  !*** ./app/javascript/text_expanding.js ***!
  \******************************************/
/*! no exports provided */
...
function fetch_textexpand_menu(type, text, callback) {
  ...
  var query = encodeURIComponent(text); // TODO: dear LORD clean this up, catch errors, etc
...
/***/ "./app/javascript/textarea_sizing.js":
/*!*******************************************!*\
  !*** ./app/javascript/textarea_sizing.js ***!
  \*******************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _github_textarea_autosize__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @github/textarea-autosize */ "./node_modules/@github/textarea-autosize/dist/index.js");
...
document.addEventListener("turbolinks:load", function () {
  ...
  if (existing_textarea = document.querySelector("textarea")) {
    Object(_github_textarea_autosize__WEBPACK_IMPORTED_MODULE_0__["default"])(existing_textarea);
...
function () {
  function Combobox(input, list) {
    ...
    this.keyboardEventHandler = function (event) {
      return keyboardBindings(event, _this);
    };

    this.compositionEventHandler = function (event) {
      return trackComposition(event, _this);
    };
  ...
  _createClass(Combobox, [{
    ...
    value: function navigate() {
      var indexDiff = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      var focusEl = Array.from(this.list.querySelectorAll('[aria-selected="true"]')).filter(visible)[0];
      var els = Array.from(this.list.querySelectorAll('[role="option"]')).filter(visible);
    ...
    value: function clearSelection() {
      ...
      try {
        for (var _iterator2 = this.list.querySelectorAll('[aria-selected="true"]')[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var el = _step2.value;
          el.setAttribute('aria-selected', 'false');
        }
      } catch (err) {
...
function trackComposition(event, combobox) {
  ...
  var list = document.getElementById(combobox.input.getAttribute('aria-controls') || '');
  if (!list) return;
  combobox.clearSelection();
}
...
/* harmony import */ var _github_combobox_nav__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @github/combobox-nav */ "./node_modules/@github/combobox-nav/dist/index.js");
...
function query(text, key, cursor) {
  ...
  var keyIndex = text.lastIndexOf(key, cursor - 1);
...
function textFieldMirror(textField, markerPosition) {
  ...
  if (mirror && mirror.parentElement === textField.parentElement) {
    ...
    var style = window.getComputedStyle(textField);
    ...
    for (var i = 0, len = propertyNamesToCopy.length; i < len; i++) {
      var name = propertyNamesToCopy[i];
  ...
  if (typeof markerPosition === 'number') {
    var text = textField.value.substring(0, markerPosition);
    ...
    var _text = textField.value;

    if (_text) {
      before = document.createTextNode(_text);
    }
  }
...
function textFieldSelectionPosition(field) {
  var index = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : field.selectionEnd;

  var _textFieldMirror = textFieldMirror(field, index),
...
/*#__PURE__*/
function () {
  function TextExpander(expander, input) {
  ...
  _createClass(TextExpander, [{
    ...
    key: "activate",
    value: function activate(match, menu) {
      ...
      this.combobox = new _github_combobox_nav__WEBPACK_IMPORTED_MODULE_1__["default"](this.input, menu);

      var _textFieldSelectionPo = textFieldSelectionPosition(this.input, match.position),
    ...
    value: function onCommit(_ref2) {
      ...
      if (!match) return;
      var beginning = this.input.value.substring(0, match.position - match.key.length);
      var remaining = this.input.value.substring(match.position + match.text.length);
      var detail = {
        item: item,
        key: match.key,
        value: null
      };
      var canceled = !this.expander.dispatchEvent(new CustomEvent('text-expander-value', {
        cancelable: true,
        detail: detail
      }));
      if (canceled) return;
      ...
      var cursor = beginning.length + value.length;
      this.deactivate();
      this.input.focus();
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                this.match = match;
                _context.next = 8;
                return this.notifyProviders(match);
    ...
    value: function findMatch() {
      var cursor = this.input.selectionEnd || 0;
      ...
      try {
        for (var _iterator = this.expander.keys[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var _ref4 = _step.value;
          var key = _ref4.key;
          var multiWord = _ref4.multiWord;
          var found = query(text, key, cursor, {
            multiWord: multiWord,
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(match) {
        var providers, provide, canceled, all, fragments;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                provide = function provide(result) {
                  return providers.push(result);
                };

                canceled = !this.expander.dispatchEvent(new CustomEvent('text-expander-change', {
                  cancelable: true,
                  detail: {
                    provide: provide,
                    text: match.text,
              ...
              case 7:
                all = _context2.sent;
                fragments = all.filter(function (x) {
                  return x.matched;
                }).map(function (x) {
                  return x.fragment;
                });
                return _context2.abrupt("return", fragments[0]);
...
function (_HTMLElement) {
  ...
  function TextExpanderElement() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(TextExpanderElement).apply(this, arguments));
  }

  _createClass(TextExpanderElement, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      var input = this.querySelector('input[type="text"], textarea');
      if (!(input instanceof HTMLInputElement || input instanceof HTMLTextAreaElement)) return;
      var state = new TextExpander(this, input);
    ...
    key: "keys",
    get: function get() {
      var keysAttr = this.getAttribute('keys');
      var keys = keysAttr ? keysAttr.split(' ') : [];
      var multiWordAttr = this.getAttribute('multiword');
      var multiWord = multiWordAttr ? multiWordAttr.split(' ') : [];
      var globalMultiWord = multiWord.length === 0 && this.hasAttribute('multiword');
...
/* harmony default export */ __webpack_exports__["default"] = (TextExpanderElement);

/***/ }),

/***/ "./node_modules/@github/textarea-autosize/dist/index.js":
/*!**************************************************************!*\
  !*** ./node_modules/@github/textarea-autosize/dist/index.js ***!
  \**************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return autosize; });
...
/******/ });
//# sourceMappingURL=application-b2dd53d71430ec67c2b3.js.map